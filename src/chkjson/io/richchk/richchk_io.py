...
class RichChkIo:
    ...
    def encode_chk(self, rich_chk: RichChk) -> DecodedChk:
        ...
        encode_context = self._build_encode_context(rich_chk, new_str_section)
        ...
        for chk_section in rich_chk.chk_sections:
            if isinstance(chk_section, DecodedUnknownSection):
                ...
                decoded_sections.append(transcoder.encode(chk_section, encode_context))
            else:
    ...
    def _build_decode_context(self, chk: DecodedChk) -> RichChkDecodeContext:
        return RichChkDecodeContext(
            _rich_str_lookup=RichStrLookupBuilder().build_lookup(
    ...
    def _build_encode_context(
        self, chk: RichChk, new_str_section: DecodedStrSection
