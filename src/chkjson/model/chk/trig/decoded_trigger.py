...
from .decoded_condition import DecodedCondition
...
class DecodedTrigger:
    ...
    _conditions: list[DecodedCondition]
    _actions: list[DecodedAction]
    _player_execution: DecodedPlayerExecution

    @property
    def conditions(self) -> list[DecodedCondition]:
    ...
    @property
    def actions(self) -> list[DecodedAction]:
