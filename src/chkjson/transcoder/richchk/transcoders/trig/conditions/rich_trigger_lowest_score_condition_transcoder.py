...
from ......model.richchk.trig.conditions.lowest_score_condition import (
    LowestScoreCondition,
)
...
class RichTriggerLowestScoreConditionTranscoder(
    RichTriggerConditionTranscoder[LowestScoreCondition, DecodedTriggerCondition],
    _RichTriggerConditionRegistrableTranscoder,
    trigger_condition_id=LowestScoreCondition.condition_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(RichTriggerLowestScoreConditionTranscoder.__name__)
    ...
    def _decode(
        ...
        assert decoded_condition.condition_id == LowestScoreCondition.condition_id().id
        return LowestScoreCondition(
    ...
    def _encode(
        self,
        rich_condition: LowestScoreCondition,
