"""Decode Score trigger condition."""
...
from ......model.richchk.trig.conditions.score_condition import ScoreCondition
...
class RichTriggerScoreConditionTranscoder(
    RichTriggerConditionTranscoder[ScoreCondition, DecodedTriggerCondition],
    _RichTriggerConditionRegistrableTranscoder,
    trigger_condition_id=ScoreCondition.condition_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(RichTriggerScoreConditionTranscoder.__name__)
    ...
    def _decode(
        ...
        assert decoded_condition.condition_id == ScoreCondition.condition_id().id
