...
0x00 - Inactive 0x01 - Computer (game) [invalid] 0x02 - Occupied by Human Player
[invalid] 0x03 - Rescue Passive 0x04 - Unused 0x05 - Computer 0x06 - Human (Open Slot)
0x07 - Neutral 0x08 - Closed slot [invalid]
"""
...
class DecodedOwnrSection(DecodedChkSection):
    ...
    :param _player_controllers: u8[12] one byte per player slot indicating controller
        type
    """
