...
class _KillUnitAtLocationActionBase(RichTriggerAction, ABC):
    _group: PlayerId
    _amount: int
    _unit: UnitId
    ...
    def action_id(cls) -> TriggerActionId:
        return TriggerActionId.KILL_UNIT_AT_LOCATION
...
@dataclasses.dataclass(frozen=True)
class KillUnitAtLocationAction(
    _RichTriggerActionDefaultsBase, _KillUnitAtLocationActionBase
):
    pass
