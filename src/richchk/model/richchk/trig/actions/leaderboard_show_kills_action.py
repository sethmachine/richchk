...
class _LeaderboardShowKillsActionBase(RichTriggerAction, ABC):
    _text: RichString
    _unit: UnitId

    @classmethod
    def action_id(cls) -> TriggerActionId:
        return TriggerActionId.LEADER_BOARD_KILLS
...
@dataclasses.dataclass(frozen=True)
class LeaderboardShowKillsAction(
    _RichTriggerActionDefaultsBase, _LeaderboardShowKillsActionBase
):
    pass
