...
from ......model.richchk.trig.actions.kill_unit_action import KillUnitAction
...
class RichTriggerKillUnitActionTranscoder(
    RichTriggerActionTranscoder[KillUnitAction, DecodedTriggerAction],
    _RichTriggerActionRegistrableTranscoder,
    trigger_action_id=KillUnitAction.action_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(RichTriggerKillUnitActionTranscoder.__name__)
    ...
    def _decode(
        ...
        assert decoded_action.action_id == KillUnitAction.action_id().id
        return KillUnitAction(
