...
from ......model.richchk.trig.actions.kill_unit_at_location_action import (
...
class RichTriggerKillUnitAtLocationActionTranscoder(
    RichTriggerActionTranscoder[KillUnitAtLocationAction, DecodedTriggerAction],
    _RichTriggerActionRegistrableTranscoder,
    trigger_action_id=KillUnitAtLocationAction.action_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(
            RichTriggerKillUnitAtLocationActionTranscoder.__name__
        )
    ...
    def _decode(
        ...
        assert decoded_action.action_id == KillUnitAtLocationAction.action_id().id
    ...
    def _encode(
        self,
        rich_action: KillUnitAtLocationAction,
