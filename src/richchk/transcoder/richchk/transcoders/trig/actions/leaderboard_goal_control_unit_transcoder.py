...
from ......model.richchk.trig.actions.leaderboard_goal_control_unit_action import (
    LeaderboardGoalControlUnitAction,
)
...
class RichTriggerLeaderboardGoalControlUnitTranscoder(
    RichTriggerActionTranscoder[LeaderboardGoalControlUnitAction, DecodedTriggerAction],
    _RichTriggerActionRegistrableTranscoder,
    trigger_action_id=LeaderboardGoalControlUnitAction.action_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(
            RichTriggerLeaderboardGoalControlUnitTranscoder.__name__
        )
    ...
    def _decode(
        ...
        assert (
            decoded_action.action_id == LeaderboardGoalControlUnitAction.action_id().id
        )
        return LeaderboardGoalControlUnitAction(
    ...
    def _encode(
        self,
        rich_action: LeaderboardGoalControlUnitAction,
