...
from ......model.richchk.trig.actions.leaderboard_show_control_unit_at_location_action import (
    LeaderboardShowControlUnitAtLocationAction,
)
...
class RichTriggerLeaderboardShowControlUnitAtLocationActionTranscoder(
    RichTriggerActionTranscoder[
        LeaderboardShowControlUnitAtLocationAction, DecodedTriggerAction
    ],
    _RichTriggerActionRegistrableTranscoder,
    trigger_action_id=LeaderboardShowControlUnitAtLocationAction.action_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(
            RichTriggerLeaderboardShowControlUnitAtLocationActionTranscoder.__name__
        )
    ...
    def _decode(
        ...
        assert (
            ...
            == LeaderboardShowControlUnitAtLocationAction.action_id().id
        )
        ...
        return LeaderboardShowControlUnitAtLocationAction(
    ...
    def _encode(
        self,
        rich_action: LeaderboardShowControlUnitAtLocationAction,
