...
from ......model.richchk.trig.actions.leaderboard_show_kills_action import (
    LeaderboardShowKillsAction,
)
...
class RichTriggerLeaderboardShowKillsTranscoder(
    RichTriggerActionTranscoder[LeaderboardShowKillsAction, DecodedTriggerAction],
    _RichTriggerActionRegistrableTranscoder,
    trigger_action_id=LeaderboardShowKillsAction.action_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(RichTriggerLeaderboardShowKillsTranscoder.__name__)
    ...
    def _decode(
        ...
        assert decoded_action.action_id == LeaderboardShowKillsAction.action_id().id
        return LeaderboardShowKillsAction(
    ...
    def _encode(
        self,
        rich_action: LeaderboardShowKillsAction,
