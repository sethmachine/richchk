"""Decode Minimap Ping trigger action."""

from ......model.chk.trig.decoded_trigger_action import DecodedTriggerAction
from ......model.richchk.mrgn.rich_location import RichLocation
from ......model.richchk.richchk_decode_context import RichChkDecodeContext
from ......model.richchk.richchk_encode_context import RichChkEncodeContext
from ......model.richchk.trig.actions.minimap_ping_action import MinimapPingAction
...
class RichTriggerMinimapPingActionTranscoder(
    RichTriggerActionTranscoder[MinimapPingAction, DecodedTriggerAction],
    _RichTriggerActionRegistrableTranscoder,
    trigger_action_id=MinimapPingAction.action_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(RichTriggerMinimapPingActionTranscoder.__name__)
    ...
    def _decode(
        ...
        assert decoded_action.action_id == MinimapPingAction.action_id().id
        ...
        return MinimapPingAction(
            _location=maybe_location,
        )

    def _encode(
        self,
        rich_action: MinimapPingAction,
