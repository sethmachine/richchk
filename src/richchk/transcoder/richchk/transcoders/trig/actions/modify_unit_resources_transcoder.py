...
from ......model.richchk.trig.actions.modify_unit_resources import (
    ModifyUnitResourcesAction,
)
...
class RichTriggerModifyUnitResourcesActionTranscoder(
    RichTriggerActionTranscoder[ModifyUnitResourcesAction, DecodedTriggerAction],
    _RichTriggerActionRegistrableTranscoder,
    trigger_action_id=ModifyUnitResourcesAction.action_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(
            RichTriggerModifyUnitResourcesActionTranscoder.__name__
        )
    ...
    def _decode(
        ...
        assert decoded_action.action_id == ModifyUnitResourcesAction.action_id().id
        ...
        return ModifyUnitResourcesAction(
            ...
            _resource_amount=decoded_action.second_group,
            _location=maybe_location,
        )

    def _encode(
        self,
        rich_action: ModifyUnitResourcesAction,
        ...
        return DecodedTriggerAction(
            ...
            _second_group=rich_action.resource_amount,
