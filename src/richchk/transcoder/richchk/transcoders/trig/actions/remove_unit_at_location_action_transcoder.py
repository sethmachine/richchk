...
from ......model.richchk.trig.actions.remove_unit_at_location_action import (
...
class RichTriggerRemoveUnitAtLocationActionTranscoder(
    RichTriggerActionTranscoder[RemoveUnitAtLocationAction, DecodedTriggerAction],
    _RichTriggerActionRegistrableTranscoder,
    trigger_action_id=RemoveUnitAtLocationAction.action_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(
            RichTriggerRemoveUnitAtLocationActionTranscoder.__name__
        )
    ...
    def _decode(
        ...
        assert decoded_action.action_id == RemoveUnitAtLocationAction.action_id().id
    ...
    def _encode(
        self,
        rich_action: RemoveUnitAtLocationAction,
