"""Decode Disable/Enable doodad state trigger action."""

from ......model.chk.trig.decoded_trigger_action import DecodedTriggerAction
from ......model.richchk.mrgn.rich_location import RichLocation
from ......model.richchk.richchk_decode_context import RichChkDecodeContext
from ......model.richchk.richchk_encode_context import RichChkEncodeContext
from ......model.richchk.trig.actions.set_doodad_state_action import (
    SetDoodadStateAction,
)
from ......model.richchk.trig.enums.doodad_action import DoodadAction
...
class RichTriggerSetDoodadStateTranscoder(
    RichTriggerActionTranscoder[SetDoodadStateAction, DecodedTriggerAction],
    _RichTriggerActionRegistrableTranscoder,
    trigger_action_id=SetDoodadStateAction.action_id(),
):
    def __init__(self) -> None:
        self.log = logger.get_logger(RichTriggerSetDoodadStateTranscoder.__name__)
    ...
    def _decode(
        ...
        assert decoded_action.action_id == SetDoodadStateAction.action_id().id
        ...
        return SetDoodadStateAction(
            ...
            _doodad_action=RichChkEnumTranscoder.decode_enum(
                decoded_action.quantifier_or_switch_or_order, DoodadAction
            ),
        )

    def _encode(
        self,
        rich_action: SetDoodadStateAction,
