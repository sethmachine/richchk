...
WINDOWS_STORMLIB_X86_64 = Path(
    Path.joinpath(_RESOURCES_DIR_PATH, "stormlib/windows/x64/StormLib.dll")
).absolute()
...
EXAMPLE_OGG_FILE = Path(
    Path.joinpath(_RESOURCES_DIR_PATH, "stormlib/wavs/bandit1.ogg")
).absolute()
