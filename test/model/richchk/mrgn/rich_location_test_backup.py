...
def test_locations_are_equal_if_all_fields_match_but_no_index_defined():
...
def test_locations_are_not_unique_in_set_if_all_fields_match_but_no_index_defined():
    loc1 = RichLocation(0, 0, 0, 0, RichString(_value="location 1"), _index=None)
    loc2 = RichLocation(0, 0, 0, 0, RichString(_value="location 1"), _index=None)
    loc_set = {loc1, loc2}
...
def test_locations_equal_and_unique_if_atleast_one_has_undefined_index():
    loc1 = RichLocation(0, 0, 0, 0, RichString(_value="location 1"), _index=1)
    loc2 = RichLocation(0, 0, 0, 0, RichString(_value="location 1"), _index=None)
    loc_set = {loc1, loc2}
    assert loc1 == loc2
